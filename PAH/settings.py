"""
Django settings for PAH project.
...
SECRET_KEY = 'django-insecure-da-y*^fc&(h+r@9!v=t4e0ke15#x$$5_5$1_2d^yth*#f!vl(g'
...
WSGI_APPLICATION = 'PAH.wsgi.application'
